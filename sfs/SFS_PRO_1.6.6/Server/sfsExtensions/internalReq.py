...
#
# This method handles an internal request which may come from another
# object such as an extension or a servlet running in the embedded webserver
#
# The method is expected to return an object
#
def handleInternalRequest(obj):
	from java.util import ArrayList
	
	print "Inside internal request: ", obj
